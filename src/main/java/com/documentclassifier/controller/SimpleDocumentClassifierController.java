...
import com.documentclassifier.service.SimpleVaultGemmaService;
...
@RestController
@RequestMapping("/api")
public class SimpleDocumentClassifierController {
    
    private static final Logger logger = LoggerFactory.getLogger(SimpleDocumentClassifierController.class);
    
    private final LocalVaultGemmaService localVaultGemmaService;
    private final SimpleVaultGemmaService vaultGemmaService;
    
    @Value("${vaultgemma.enabled:true}")
    private boolean vaultGemmaEnabled;
    
    @Autowired
    public SimpleDocumentClassifierController(
            LocalVaultGemmaService localVaultGemmaService,
            SimpleVaultGemmaService vaultGemmaService) {
